...
{	
	...
	double newHeight = stdin_custom->Height;
	m_main = std::unique_ptr<dxxamlapp1Main>(new dxxamlapp1Main(
		m_deviceResources, newHeight));
...
void printfxw(wchar_t* arg, ...);

void DirectXPage::OnKeyDownHandler(Platform::Object^ sender, Windows::UI::Xaml::Input::KeyRoutedEventArgs^ e)
{
	if (e->Key == Windows::System::VirtualKey::Enter)
	{
		if (wcscmp(stdin_custom->Text->Data(), L"") != 0)
		{
#ifndef testing
			std::string cmd;
